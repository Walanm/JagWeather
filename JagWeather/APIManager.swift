            ...
            if httpResponse.statusCode == 200 { // THIS IS THE CODE FOR A VALID, COMPLETE RESPONSE
                ...
                do {
                    ...
                    if let thisCondition = jsonData.objectForKey("current_observation") as? [String:AnyObject] {
                        ...
                        conditionDictionary["temp_f"] = String(thisCondition["temp_f"]!)
                        conditionDictionary["wind_mph"] = String(thisCondition["wind_mph"]!)
                        conditionDictionary["wind_dir"] = String(thisCondition["wind_dir"]!)
                        conditionDictionary["display_location"] = thisCondition["display_location"]!["full"]! as? String
                        conditionDictionary["feelslike_f"] = String(thisCondition["feelslike_f"]!)
                        conditionDictionary["relative_humidity"] = String(thisCondition["relative_humidity"]!)
